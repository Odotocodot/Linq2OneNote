...
namespace Odotocodot.OneNote.Linq
{
    ...
    public static class OneNoteApplication
    {
        ...
        private static Lazy<Application> GetLazyOneNote() => new(() => new Application(), LazyThreadSafetyMode.ExecutionAndPublication);
        ...
        private static void CreateItemBase<T>(IApplication oneNote, IOneNoteItem parent, string name, bool openImmediately) where T : IOneNoteItem
        {
            ...
            switch (typeof(T).Name) //kinda smelly
            {
                case nameof(OneNoteNotebook):
                    ...
                    path = System.IO.Path.Combine(GetDefaultNotebookLocation(oneNote), name);
